...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'soft': '0 1px 3px rgb(0 0 0 / 0.15), 0 4px 12px rgb(0 0 0 / 0.2)',
        'card': '0 2px 8px rgb(0 0 0 / 0.18), 0 6px 20px rgb(0 0 0 / 0.15)',
        'card-hover': '0 8px 24px rgb(0 0 0 / 0.2), 0 4px 12px rgb(0 0 0 / 0.15)',
        'glow-primary': '0 0 16px rgb(var(--primary-500) / 0.15), 0 0 32px rgb(var(--primary-500) / 0.08)',
        'glow-accent': '0 0 16px rgb(var(--accent-500) / 0.15), 0 0 32px rgb(var(--accent-500) / 0.08)',
      },
    },
  },
  plugins: [],
